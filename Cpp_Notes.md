...
- Cool solution for swapping 2 integers without using a `temp` variable.
  ```C++
  #include <iostream>
  ...
  ```
- Interesting C++ interview questions are available [here](https://www.toptal.com/c-plus-plus/interview-questions#iquestion_form).
